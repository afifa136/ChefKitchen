...
// TODO : Create a new folder named "CONSTANTS" and move all the constants data like dishes, sidebarIcons, etc.
// TODO : Split the code in to small component for the better readability and maintainability
// TODO : Make the items centere in the card like in the figma
// TODO : Fix the cart logic 
    ...
    <div className="bg-[#0F0F1A] min-h-screen">
      <div className="max-w-[1600px] mx-auto flex relative">
        ...
        <div className="flex-1 flex relative transition-all duration-300">
          {/* MAIN CONTENT */}
          <main
            className={`flex-1 p-4 sm:p-6 lg:p-8 text-white transition-all duration-300 ${
              showOrderPanel ? "mr-[3px]" : "mr-0"
            }`}
          >
            {/* Notification */}
            {notification && (
              ...
              <div className="flex gap-6 sm:gap-10 min-w-max">
                {[
                  ...
                  >
                    {tab.label}
                    {activeCategory === tab.key && (
                      <span className="absolute left-0 -bottom-[1px] w-full h-[2px] bg-orange-400 rounded-full" />
                    )}
                  </button>
                ))}
              </div>
                ...
                return (
                  <div key={dish.id} className="bg-[#06060c] p-4 rounded-2xl">
                    <img
                      src={dish.image}
                      alt={dish.name}
                      className="w-24 h-24 mx-auto -mt-14 mb-4 border-3 border-gray-950 rounded-full"
                    />
                        ...
                        <button
                          ...
                          className={`w-8 h-8 text-xs rounded-md ${
                            selectedSizes[dish.id] === s
                              ...
                              : "bg-[#24243C] hover:bg-orange-400 hover:text-black"
                          }`}
                        >
                          {s}
                        </button>
